...
class TestSonarCloudIntegration:
    ...
    def test_git_url_parsing(self):
        ...
        test_cases = [
            # GitHub HTTPS
            ("https://github.com/owner/repo.git", {"owner": "owner", "repo": "repo", "project_key": "owner_repo"}),
            ("https://github.com/owner/repo", {"owner": "owner", "repo": "repo", "project_key": "owner_repo"}),
            ("https://www.github.com/owner/repo/", {"owner": "owner", "repo": "repo", "project_key": "owner_repo"}),
            
            # GitHub SSH
            ("git@github.com:owner/repo.git", {"owner": "owner", "repo": "repo", "project_key": "owner_repo"}),
            ("git@github.com:owner/repo", {"owner": "owner", "repo": "repo", "project_key": "owner_repo"}),
            
            # GitLab HTTPS
            ("https://gitlab.com/owner/repo.git", {"owner": "owner", "repo": "repo", "project_key": "owner_repo"}),
            ("https://www.gitlab.com/owner/repo", {"owner": "owner", "repo": "repo", "project_key": "owner_repo"}),
            
            # GitLab SSH
            ("git@gitlab.com:owner/repo.git", {"owner": "owner", "repo": "repo", "project_key": "owner_repo"}),
    ...
    def test_configuration_validation_success(self, mock_session_class):
        ...
        mock_response.json.return_value = {
            "organizations": [
                {"key": "test-org", "name": "Test Organization"}
            ]
        }
    ...
    def test_configuration_validation_invalid_org(self, mock_session_class):
        ...
        mock_response.json.return_value = {
            "organizations": [
                {"key": "other-org", "name": "Other Organization"}
            ]
        }
        mock_session.get.return_value = mock_response
        mock_session_class.return_value = mock_session

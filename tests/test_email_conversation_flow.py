...
"""
        ...
        def update_state_email2(*args, **kwargs):
            ...
            if "email_history = list_append" in kwargs.get("UpdateExpression", ""):
                ...
                if kwargs["ExpressionAttributeValues"][":current_seq"] != conversation_state["last_seq"]:
...
Answers to questions..."""
    ...
    def test_conversation_metrics(self):
        ...
        for i in range(1, len(email_history)):
            if (email_history[i]["direction"] == "outbound" and 
                email_history[i-1]["direction"] == "inbound"):
                t1 = datetime.fromisoformat(email_history[i-1]["timestamp"].replace("Z", "+00:00"))

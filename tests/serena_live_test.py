    ...
    def setup_class(cls):
        ...
        try:
            ...
            if result.returncode != 0:
                pytest.fail("Serena MCP server is not running. Start it with: serena-mcp-server --port 9123")
    ...
    def test_benchmark_produces_real_metrics(self):
        ...
        results = {
            ...
            "comparison": {
                ...
                "percentage_change": ((len(serena_context) - len(legacy_context)) / len(legacy_context) * 100)
            }
        }

...
""")
    ...
    readme.write_text("""# Test Milestone
...
def bad_code_milestone(temp_milestone_dir):
    ...
    bad_py.write_text("""# No shebang, no docstring, poor formatting
...
""")
    ...
    syntax_error_py.write_text("""#!/usr/bin/env python3
...
class TestReviewerAgentIntegration:
    ...
    @patch("agents.review.reviewer_agent.get_provider")
    def test_end_to_end_review_workflow(self, mock_get_provider, good_code_milestone, mock_provider):

...
class TestMarketingPoster:
    ...
    def test_announce_with_planning(self, milestone_with_planning):
        ...
        assert result["announcement"] != ""
        assert (
            "API Development Sprint" in result["announcement"]
            or "API Development" in result["announcement"]
        )
        assert "#SoloPilot" in result["announcement"]
...
class TestMarketingPosterIntegration:
    ...
    def test_different_milestone_types(
        self, milestone_with_manifest, milestone_with_planning, empty_milestone
    ):

...
from agents.dev.context_engine.serena_engine import SerenaContextEngine, SerenaLSPError
...
""")
    ...
    def test_serena_unavailable_fallback(self, mock_run):
        ...
        with patch('agents.dev.context_engine.LegacyContextEngine') as mock_legacy:
            mock_legacy.return_value.build_context.return_value = ("legacy context", {"engine": "legacy"})
    ...
    def test_symbol_extraction_from_milestone(self, mock_run):
        ...
        expected_symbols = {"UserController", "AuthService", "authenticate", "validateToken", "User", "Token"}
...
class TestSerenaIntegration(unittest.TestCase):
    ...
    def test_serena_fallback_in_factory(self):
        ...
        with patch.dict('os.environ', {'CONTEXT_ENGINE': 'serena'}):
            with patch('agents.dev.context_engine.serena_engine.SerenaContextEngine') as mock_serena:

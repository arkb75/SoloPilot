...
"""
        ...
        for result in results:
            ...
            self.assertEqual(result.tool.lower().replace("linter", ""), result.tool.lower().replace("linter", ""))
    ...
    def test_has_critical_errors(self):
        ...
        error_result = LintResult(success=True, issues=[
            {"severity": "error", "message": "Test error"}
        ], tool="test")
        warning_result = LintResult(success=True, issues=[

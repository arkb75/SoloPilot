        ...
        if "Review Comments" in content:
            ...
            for file_ref, message in file_matches:
                ...
                comments.append({
                    ...
                    "line": int(file_ref.split(':')[1]) if ':' in file_ref and file_ref.split(':')[1].isdigit() else 0,
                    "severity": severity,
...
def main():
    ...
    if not status["can_post_reviews"]:
        ...
        print(f"Reason: No network={status['no_network_mode']}, "

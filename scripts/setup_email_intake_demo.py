...
class EmailIntakeSetup:
    ...
    def _create_table(self) -> bool:
        ...
        try:
            ...
            table.meta.client.get_waiter("table_exists").wait(
                TableName=self.table_name, WaiterConfig={"Delay": 2, "MaxAttempts": 30}
            )
    ...
    def _setup_ttl(self) -> None:
        ...
        try:
            ...
            response = self.dynamodb_client.describe_time_to_live(TableName=self.table_name)
    ...
    def check_ses_configuration(self) -> bool:
        ...
        try:
            ...
            if self.sender_email in verification_attrs:
                ...
                logger.info(
                    "   Run: aws ses verify-email-identity --email-address " + self.sender_email
                )
    ...
    def update_lambda_configuration(self, queue_url: str) -> bool:
        ...
        try:
            ...
            waiter.wait(FunctionName=self.lambda_name, WaiterConfig={"Delay": 2, "MaxAttempts": 30})
    ...
    def upload_lambda_package(self) -> bool:
        ...
        try:
            ...
            self.lambda_client.update_function_code(FunctionName=self.lambda_name, ZipFile=zip_data)
